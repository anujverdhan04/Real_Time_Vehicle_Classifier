...
import { Webcam } from "./webUtils/camHandle";
...
const ButtonHandler = ({ imageRef, cameraRef, videoRef }) => {
  ...
  return (
    <div className="btn-container">
      ...
      />
      <button
        className={`web-btn ${streaming === "image" ? "close-btn" : ""}`}
        onClick={() => {
          // if not streaming
      ...
      />
      <button
        className={`web-btn ${streaming === "video" ? "close-btn" : ""}`}
        onClick={() => {
          // if not streaming
      ...
      {/* Webcam Handler */}
      <button
        className={`web-btn ${streaming === "camera" ? "close-btn" : ""}`}
        onClick={() => {
          // if not streaming
